...
function findOne() {
    ...
    $.ajax({
        ...
        success: function (data) {
            $("#page3").empty()
            if (data.id === null){
                $("#page3").append("<h1 style='color: white'>已经没有匹配的用户了哦！！</h1>+" +
                    "<h1 style='color: white'>试着按条件搜索一下吧！！</h1>")

            }else {
                $("#page3").append("<div class='col-md-12 biseller-column'>" +
                    "                                <a href='" + contextPath + "profile/" + data.id + "'>" +
                    "                                    <div class='profile-image'>" +
                    "                                        <img src='" + contextPath + "file?path=" + data.photo + "' class='img-responsive'" +
                    "style='width: 516px;height: 516px;' alt='profile image'/>" +
                    "                                        <div class='agile-overlay'>" +
                    "                                            <h4>" + data.nickname +
                    "                                                <img  src='" + contextPath + "images/vip" + (data.vip ? "" : "-grey") + ".png' class='snap-flag'/>" +
                    "                                                <img src='" + contextPath + "images/star-0" + (data.star ? "" : "-grey") + ".png' class='flag'>" +
                    "                                            </h4>" +
                    "                                            <ul>" +
                    "                                                <li><span>" + data.age + "岁" + "</span>" + data.workplace + "</li>" +
                    "                                                <li><span>" + data.height + "cm" + "</span>" + data.salary + "元" + "</li>" +
                    "                                            </ul>" +
                    "                                        </div>" +
                    "                                    </div>" +
                    "                                </a>" +
